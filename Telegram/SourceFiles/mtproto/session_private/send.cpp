...
bool SessionPrivate::sendSecureRequest(
	...
	SHA256_Update(&msgKeyLargeContext, _sessionState.encryptionKey->partForMsgKey(true), 32);
	...
	const auto msgKey = binary::ReadAt<MTPint128>(
		bytes::make_span(encryptedSHA256),
		8);
